...
<BODY>
	<FORM id=form1 name=form1
		action="${pageContext.request.contextPath }/link/addLink.do"
		method=post>
					...
					<TD vAlign=top width="100%" bgColor=#ffffff>
						...
						<TABLE cellSpacing=0 cellPadding=5  border=0>
							...
							<TR>
								...
								<td>联系人性别：</td>
								<td>
								<input type="radio" value="男" checked="checked" name="lkm_gender">男
							...
							<TR>
								...
								<td>所属客户：</td>
								<td colspan="3">
									<select name="cstCustomer.cust_id">
									<c:forEach items="${customer}" var="cstCustomer">
										<option value="${cstCustomer.cust_id}">${cstCustomer.cust_name}</option>
									</c:forEach>
								</select>
								</td>
							</TR>
