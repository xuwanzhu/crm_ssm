...
<body>
<FORM id=form1 name=form1 action="${pageContext.request.contextPath }/user/register.do" method=post>
        ...
        <TR>
          ...
          <TD>
            <TABLE cellSpacing=0 cellPadding=2 border=0>
              <TBODY>
              <TR>
                <TD style="HEIGHT: 28px" width=100>注册登录名：</TD>
              ...
              <TR>
                <TD style="HEIGHT: 28px" width=120>注册登录密码：</TD>
              ...
              <TR>
                ...
                <INPUT id=btn 
                  ...
                  onclick="register()"
                  type="button" src="${pageContext.request.contextPath }/images/login_button.gif" name=btn value="注册">
              </TD>
               ...
               <TD>
                <INPUT id=btn2 
                  style="BORDER-TOP-WIDTH: 0px; BORDER-LEFT-WIDTH: 0px; BORDER-BOTTOM-WIDTH: 0px; BORDER-RIGHT-WIDTH: 0px" 
                  onclick="login()"
                  type="button" name=btn value="返回登录"> 
              </TD>
